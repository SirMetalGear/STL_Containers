...
/*   Updated: 2021/05/18 14:13:43 by mlorette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	testPush_back()
{
	...
	for (std::list<int>::iterator item = mylist.begin(); item != mylist.end(); ++item) {
...
{
	std::list<int> first (3, 100);      // list of 3 zero-initialized ints
	std::list<int> second (5, 200);     // list of 5 zero-initialized ints
